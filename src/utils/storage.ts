...
export const saveUserAnswer = (questionPool: string, questionId: number, isCorrect: boolean) => {
...
export const getQuestionScore = (questionPool: string, questionId: number): number => {
